...
$sql_query = "SELECT whenquery AS start FROM " . MYSQL_TABLE . " WHERE {$sql_interval} ORDER BY whenquery ASC LIMIT 0, 1";
...
$sql_query = "SELECT whenquery AS stop FROM " . MYSQL_TABLE . " WHERE {$sql_interval} ORDER BY whenquery DESC LIMIT 0, 1";
...
<html>
    ...
    <body>
        <div id="page">
            ...
            <h2>Start working at <?php echo $inv_start; ?> and stop working at <?php echo $inv_stop; ?></h2>
            <img src="images.php" alt="Graph" title="Graph" />
        </div>
    </body>
